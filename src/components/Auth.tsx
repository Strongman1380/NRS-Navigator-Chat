        ...
        <div className="bg-white rounded-2xl shadow-xl p-5 sm:p-6 md:p-8">
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                <p className="text-xs sm:text-sm text-slate-700 leading-relaxed">
                  <strong>Your privacy is protected.</strong> All conversations are confidential regardless of whether you use a guest session or create an account. We do not require identifying information.
                </p>
              </div>
            </div>
          </div>
          ...
          {!showAccountForm && (
            <div className="mb-5 sm:mb-6">
              <button
                onClick={() => { setShowAccountForm(true); setIsSignUp(true); }}
                ...
                <div className="flex items-start gap-2.5">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-[11px] sm:text-xs text-slate-400 mt-0.5 leading-relaxed">
                      Save conversations to revisit later. Same confidential service — your data stays private and secure.
                    </p>
                  </div>
                </div>
              </button>
              ...
              {isSignUp && (
                <div className="bg-emerald-50 border border-emerald-200 rounded-xl px-3 py-2.5 mb-4">
                  <p className="text-xs text-emerald-800 leading-relaxed">
                    <strong>Creating an account is optional</strong> and does not change how the service works. You will receive the same confidential support. The only difference is you can choose to save conversations to review them later.
                  </p>
                </div>
              )}
